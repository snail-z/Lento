...
extension DawnTodayGestureRecognizer {
    ...
    private var isScrolling: Bool {
        guard let sview = trackScrollView else { return false }
        return sview.contentOffset.y > .zero || sview.contentOffset.y < .zero
    }
